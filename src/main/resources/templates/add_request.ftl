...
<@c.body>
    <form class="needs-validation" novalidate method="post" action="/add_request" enctype="multipart/form-data">
        <table style="width: 98%;margin: auto" class="mt-2">
            ...
            <tr>
                <td>
                    <div class="form-row">
                        <div class="col-md-2 mb-3">
                            <@input.select id="typeCustomer" label="Тип">
                        ...
                        <div class="col-md-5 mb-3">
                            <@input.input id="nameCustomer" type="text" label="Наименование" value=""/>
                        </div>
                        <div class="col-md-5 mb-3">
                            <@input.input id="addressCustomer" type="text" label="Адрес" value=""/>
                        </div>
                    </div>
                </td>
                <td>
